/*
 * TCSS 305 - Homework 2: Easy Street
 * Author: Marty Stepp
...
public class EasyStreetGUI extends JFrame implements ActionListener {
  ...
  private class EasyStreetPanel extends JPanel {
    ...
    public EasyStreetPanel() {
      super();
      setPreferredSize(
          new Dimension(my_grid[0].length * SQUARE_SIZE, my_grid.length * SQUARE_SIZE));
    ...
    public void paintComponent(final Graphics the_graphics) {
      ...
      for (Vehicle mover : my_vehicles) {
        ...
        g2.drawImage(img, mover.getX() * SQUARE_SIZE,
                     mover.getY() * SQUARE_SIZE, SQUARE_SIZE, SQUARE_SIZE, this);
      ...
      if (my_debug_flag) {
        ...
        g2.drawString("Update #" + my_timestep, DEBUG_OFFSET / 2,
