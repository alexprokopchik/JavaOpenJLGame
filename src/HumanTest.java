      ...
      for (Terrain t : Terrain.values()) {
        for (Light l : Light.values()) {
          if ((t == test_terrain) || (t == Terrain.LIGHT && test_terrain == Terrain.STREET)
            ...
            assertTrue("Human started on " + test_terrain + " should be able to pass " + t
                       + ", with light " + l, human.canPass(t, l));
          } else {
            // humans can't leave their terrain

            assertFalse("Human started on " + test_terrain + " should NOT be able to pass "
                        + t + ", with light " + l, human.canPass(t, l));
          }
        }
      }
    }
